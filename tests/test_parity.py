...
def test_html_exist_and_200():
    for f in ["index.html","play.html","model.html","players.html","methods.html","trends.html","leaderboard.html","offline.html"]:
        p=root/f
...
def test_data_active_8_8():
    count=0
    for f in ["index.html","model.html","players.html","methods.html","trends.html","leaderboard.html","offline.html","dashboard.html"]:
        p=root/f
